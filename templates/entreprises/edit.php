        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/entreprises/<?= $entreprise->getId() ?>"><?= htmlspecialchars($entreprise->getNom()) ?></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Modifier</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-2">
                <h1 class="h3 mb-2 mb-md-0">
                    <i class="bi bi-pencil-square me-2"></i>Modifier l'entreprise
                </h1>
                <div class="d-flex gap-2">
                    <a href="/entreprises" class="btn btn-outline-secondary btn-sm">
                        <i class="bi bi-arrow-left me-1"></i> Retour
                    </a>
                    <a href="/entreprises/<?= $entreprise->getId() ?>" class="btn btn-info btn-sm text-white">
            ...
            <div class="col-lg-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-header bg-white border-bottom d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary">ID: <?= $entreprise->getId() ?></span>
                    </div>
                    <div class="card-body">
                        <div class="mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <a href="<?= htmlspecialchars($entreprise->getSiteWeb()) ?>" target="_blank" class="btn btn-outline-secondary" title="Ouvrir le site">
                    ...
                    <div class="card-body p-0">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Contacts</span>
                                <?php 
                                // Compter les contacts de cette entreprise
                                $contactsCount = 0;
                                foreach ($allContacts ?? [] as $contact) {
                                    if ($contact->getIdEntreprise() === $entreprise->getId()) {
                                        $contactsCount++;
                                    }
                                }
                                ?>
                                <span class="badge bg-primary rounded-pill"><?= $contactsCount ?></span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span>Stages</span>
                                <?php 
                                // Compter les stages de cette entreprise
                                $stagesCount = 0;
                                ...
                                ?>
                                <span class="badge bg-primary rounded-pill"><?= $stagesCount ?></span>
                            </li>
