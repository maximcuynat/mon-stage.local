    ...
    <table class="table table-striped table-hover table-borderless table-dark align-middle">
        ...
        <?php if(!empty($entreprises)): ?>
            <tbody class="table-group-divider">
                ...
                <tr>
                    <td colspan="6" class="text-center">
                        <a href="/entreprises/add" class="text-decoration-none">Ajouter une entreprise<button type="button" class="btn"><i class="bi bi-plus-circle-fill text-success"></i></button></a>
                    </td>
                </tr>
            </tbody>
        <?php endif; ?>
